...
The fixtures directory mirrors a Drive content root:
    ...
    ├── scholarships/qatar-scholarship-aub/{info,info.ar}.docx
    └── expected/{aub,aub.ar,fulbright,fulbright.ar,qatar-scholarship-aub,
                  qatar-scholarship-aub.ar}.mdx
...
@pytest.fixture
def qatar_paths() -> dict[str, Path]:
    """Qatar Scholarship (AUB) — generated by `scripts/scaffold_qatar_scholarship.py`."""
    base = FIXTURES / "scholarships" / "qatar-scholarship-aub"
    return {
        "info_en": base / "info.docx",
        "info_ar": base / "info.ar.docx",
    }
