...
- [**Suggest a correction →**](https://github.com/hashemkhodor/collegesaurus/issues/new?template=inaccurate-info.yml)
  Fill the short form. We'll verify and push the fix.

## I want to add a scholarship or university we're missing
...
The more links to official pages you can include, the faster it gets
published.
...
- For new content, start from
  ...
  [`scholarships/_template.mdx`](./scholarships/_template.mdx).

## I don't have a GitHub account

Email **hashemkhoder1@gmail.com** with the subject line
`Collegesaurus contribution` and the same info you'd put in a form. We'll
file the issue for you.

## What happens after I submit?

- The maintainer reviews the issue within a few days.
- If the info is verifiable, the page is updated and the site
  redeploys automatically (usually within an hour of the merge).
- You'll be credited in the commit message unless you ask otherwise.
